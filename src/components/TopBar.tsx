...
export function TopBar({ user, title }: TopBarProps) {
  return (
    <div className="h-16 border-b border-border/30 flex items-center justify-between px-6 relative backdrop-blur-sm"
         style={{background: 'linear-gradient(180deg, rgba(255,255,255,0.95) 0%, rgba(232,245,243,0.9) 100%)'}}>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3">
          <div className="card-3d-sm p-0.5 rounded-full" style={{background: 'linear-gradient(135deg, #0d7479 0%, #5aacb1 100%)'}}>
